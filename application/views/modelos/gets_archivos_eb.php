<table class="table table-striped table-bordered table-hover">
    ...
    <tbody>
        <?php foreach(explode(',', $modelo['fotos_ebcom']) as $foto) { ?>
        <?php if(strlen($foto)) { ?>
        <tr>
            <td><img src="/Fotodisk_eb/<?=$modelo['perfil']?>/<?=$modelo['carpeta']?>/<?=$modelo['carpeta']?><?=$foto?>Thumb.jpg"></td>
...
$(".thumb").click(function() {
    window.location.href = '/modelos/thumb_eb/'+$("#idmodelo").val()+"/"+this.attributes.idfoto.value+"/";
});
